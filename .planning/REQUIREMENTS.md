...
- [ ] **FAIL-01**: Circuit breaker marks backend unhealthy after configurable consecutive 5xx failures
- [ ] **FAIL-02**: Passive failure detection from real relay traffic (5xx, timeouts, connection refused)
