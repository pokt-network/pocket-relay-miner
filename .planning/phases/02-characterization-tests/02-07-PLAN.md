...
<task type="auto">
  ...
  <action>
    ...
    **Test approach:**
    ...
    - Follow the same mock patterns established in proxy_test.go (local mock types, not testutil)
    ...
    **Important constraints:**
    ...
    - Do NOT import testutil (import cycle may still exist for existing tests). Use local helpers.
