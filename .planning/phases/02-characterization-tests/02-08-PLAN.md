...
<task type="auto">
  ...
  <action>
    ...
    **Test approach:**
    ...
    - Use local mock types ONLY for package-specific dependencies that testutil cannot provide (e.g., mock gRPC backends, service implementations)
    ...
    **Important constraints:**
    ...
    - Import testutil for shared helpers (keys, redis suite). Use local helpers only for gRPC-specific mocks.
