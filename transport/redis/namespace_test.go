...
func allKeyBuilderOutputs(kb *KeyBuilder) map[string]string {
	...
	out := map[string]string{
		...
		"SMSTLeavesKey":               kb.SMSTLeavesKey("sup1", "sess1"),
		"SMSTAllPattern":              kb.SMSTAllPattern(),
...
func TestKeyBuilder_DefaultGoldenStrings(t *testing.T) {
	...
	golden := map[string]string{
		...
		"SMSTLeavesKey":            "ha:smst:sup1:sess1:leaves",
		"SMSTAllPattern":           "ha:smst:*",
...
func TestKeyBuilder_PatternsMatchOnlyTheirOwnFamily(t *testing.T) {
	expected := map[string][]string{
		...
		"SMSTAllPattern":          {"SMSTNodesKey", "SMSTRootKey", "SMSTStatsKey", "SMSTLiveRootKey", "SMSTLeavesKey"},
